...
title: "How to limit AI access to your content without disappearing from the web (Part 1)"
...
if we completely block access by artificial intelligence to our blog or web service, and most users end up using AI as their main gateway to information, **don't we risk becoming invisible?**
...
By contrast, the **full content of the article** -- where knowledge, experience, opinion, and differential value are really provided, and from which an LLM could learn -- should remain **out of reach of AI bots**. Not to hide it from the human reader, but to reserve it for those who consciously decide to visit the web.
...
Although the technical details will be developed in the **second part of this article**, it is worth previewing the general idea.
...
These measures do not prevent access for people, but they reduce the mass use of content by automated systems and the amount of information available for training.

It is worth insisting on a key idea: **none of these solutions is 100% reliable**. They are reasonable approximations in a changing scenario. In the **second part** I will go into detail on how to apply them at a technical level, with concrete examples and resources.
