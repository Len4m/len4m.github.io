...
export const translations: Record<string, Translations> = {
  en: {
    ...
    parsingText: "Parsing...",
    autoDetectionWarning: "Automatic detection is not perfect. Review and adjust detected parameters as needed.",
    ...
    useContainerLabel: "Use Container (Coming Soon)",
    networkIsolationLabel: "Network Isolation (Coming Soon)",
    filesystemRestrictionsLabel: "Filesystem Restrictions (Coming Soon)",
    runAsUserLabel: "Run As User (Coming Soon)",
  ...
  es: {
    ...
    autoDetectionWarning: "La detección automática no es perfecta. Revisa y ajusta los parámetros detectados según sea necesario.",
    ...
    sandboxingLabel: "Sandboxing",
    useContainerLabel: "Usar Contenedor (Próximamente)",
    networkIsolationLabel: "Aislamiento de Red (Próximamente)",
    filesystemRestrictionsLabel: "Restricciones de Sistema de Archivos (Próximamente)",
    runAsUserLabel: "Ejecutar Como Usuario (Próximamente)",
  ...
  ca: {
    ...
    autoDetectionWarning: "La detecció automàtica no és perfecta. Revisa i ajusta els paràmetres detectats segons sigui necessari.",
    generateButtonText: "Generar MCP",
    ...
    sandboxingLabel: "Sandboxing",
    useContainerLabel: "Usar Contenidor (Pròximament)",
    networkIsolationLabel: "Aïllament de Xarxa (Pròximament)",
    filesystemRestrictionsLabel: "Restriccions de Sistema d'Arxius (Pròximament)",
    runAsUserLabel: "Executar Com a Usuari (Pròximament)",
