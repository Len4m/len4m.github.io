...
export const translations: Record<string, Translations> = {
  en: {
    ...
    binaryNameHelp: "Only letters, numbers, hyphens and underscores. Must start with a letter.",
  ...
  es: {
    ...
    binaryNameHelp: "Solo letras, números, guiones y guiones bajos. Debe empezar con letra.",
    serverNameHelp: "Letras, números, puntos, guiones y guiones bajos. Debe empezar con letra.",
    versionHelp: "Formato: x.y.z (ej: 1.0.0)",
  ...
  ca: {
    ...
    generatedCodeLabel: "Codi Generat",
    ...
    binaryNameHelp: "Només lletres, números, guions i guions baixos. Ha de començar amb lletra.",
