...
export const translations: Record<string, Translations> = {
  en: {
    ...
    binaryNameHelp: "Letters, numbers, dots, hyphens and underscores. Must start with a letter.",
  ...
  es: {
    ...
    binaryNameHelp: "Letras, números, puntos, guiones y guiones bajos. Debe empezar con letra.",
  ...
  ca: {
    ...
    binaryNameHelp: "Lletres, números, punts, guions i guions baixos. Ha de començar amb lletra.",
