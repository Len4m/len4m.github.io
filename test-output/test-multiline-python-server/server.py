...
server = Server("test-multiline-python")
...
async def handle_list_tools() -> ListToolsResult:
    ...
    return ListToolsResult(
        tools=[
            Tool(
                name="test",
                description="Test Python server with multiline descriptions",
                inputSchema={
                    "type": "object",
                    "properties": {
            "--help": {
...
async def execute_tool(args: Dict[str, Any]) -> CallToolResult:
    ...
    try:
        ...
        result = f"Executed test with args: {json.dumps(args)}"
        ...
        async with stdio_server() as (read_stream, write_stream):
            await server.run(
                ...
                InitializationOptions(
                    server_name="test-multiline-python",
